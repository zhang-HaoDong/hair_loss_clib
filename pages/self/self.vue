<template>
	<view>
		...
		<view class="my-content">
			...
			<view class="my-content-list">
				<view class="my-content-list-title" @click="toFeedBack">
			...
			changeAvatar(){
					uni.chooseImage({
						...
						success:async res => {
							...
							// #endif
							// #ifndef H5
							let cloudPath = `wx_file_${Math.random().toString(36).slice(6)}`;
							const filePath = await this._uploadFile(res.tempFilePaths[0],cloudPath);
							// #endif
